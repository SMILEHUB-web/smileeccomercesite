...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> 08080881416</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> jephlink@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Jeph</span>-Link</h2>
              <p>Best Way to buy and sell online hurry now and sign up</p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>Suite A04 Premere Plaza, Imoiba Street Wuse Zone 3 Abuja</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-widget">
      <div class="container">
        <p>Visit Our Main office Address...You Can Applied to be our Vendor</p>
        <div class="row">
          <div class="col-sm-3">
